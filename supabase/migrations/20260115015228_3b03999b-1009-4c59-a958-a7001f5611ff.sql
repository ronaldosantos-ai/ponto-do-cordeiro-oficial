-- Harden SECURITY DEFINER RPCs to prevent probing other users unless admin

-- has_role: allow checking other users only for admins
...
-- is_premium_user: prevent checking arbitrary user_ids unless admin; avoid side effects when admin checks others
